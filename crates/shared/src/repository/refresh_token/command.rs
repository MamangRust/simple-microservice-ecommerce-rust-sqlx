use crate::{
    abstract_trait::RefreshTokenCommandRepositoryTrait,
...
impl RefreshTokenCommandRepositoryTrait for RefreshTokenCommandRepository {
    async fn create(
        ...
        let result = sqlx::query_as!(
            RefreshTokenModel,
            r#"
            INSERT INTO refresh_tokens (user_id, token, expired_date, created_at, updated_at)
            VALUES ($1, $2, $3, current_timestamp, current_timestamp)
            RETURNING refresh_token_id, user_id, token, expired_date, created_at, updated_at, deleted_at
            "#,
            request.user_id,
            request.token,
            expired_at,
    ...
    async fn update(
        ...
        let updated = sqlx::query_as!(
            ...
            SET token = $2, expired_date = $3, updated_at = current_timestamp
